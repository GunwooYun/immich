 ...
 */
export function syncAlbumToGoogleDrive({ id }: {
    id: string;
}, opts?: Oazapfts.RequestOpts) {
 ...
 */
export function getGoogleDriveAuthUrl(opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
 ...
 */
export function setGoogleDriveFolder({ googleDriveSetFolderDto }: {
 ...
 */
export function getGoogleDriveStatus(opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
